...
module.exports = function (app, passport) {
	...
	app.post('/addItem', ensureAuthenticated, function(req, res) {
		...
		var tasks = {userid : req.user.id, name : req.user.username, task : req.body.item, 
			currentLocation : req.body.currentLocation, targetLocation : [parseFloat(req.body.targetLocation[0]),parseFloat(req.body.targetLocation[1])],
